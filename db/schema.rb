...
ActiveRecord::Schema[7.0].define(version: 2022_11_28_215114) do
  ...
  create_table "reservations", force: :cascade do |t|
    ...
    t.index ["spacecraft_id"], name: "index_reservations_on_spacecraft_id"
  ...
  add_foreign_key "reservations", "spacecrafts"
